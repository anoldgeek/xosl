...
class CTextList {
	public:
		...
		void AddItem(int Index, const char *Caption, const char *HelpText,
			int Enabled, int OptionCount, const char **OptionList, int IsCombo, int LinkedListItemIndex = -1, unsigned char* MbrHDSector0List = 0 );
		...
		void SetOptionIndex(int OptionIndex, int Index);
