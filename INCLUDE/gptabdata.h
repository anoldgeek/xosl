...
/*
uint16_t f1=0xffff;
uuid_t f2 =  UUID_INIT(0x00000000, 0x0000, 0x0000, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
char f3[80] = "Teminator";
*/
//gpt_fstype_t te = {f1, f2, f3};

#if 1
gpt_fstype_t gpt_fstypes [ ] = {
	{0xffff, 
    UUID_INIT(0x00000000, 0x0000, 0x0000, 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00),  
    "Teminator"
    }
};
#else
gpt_fstype_t gpt_fstypes [ 2 ];
#endif
...
gpt_fstype_t  gpt_fstypes[ ] = 
{
  ...
  {0x7800, UUID_INIT(0x69DAD711, 0x2CE4, 0x4E3C, 0xB1,0x6C,0x21,0xA1,0xD4,0x9A,0xBE,0xD3), "GPT XOSL FS"},
...
#endif
   // Terminates array
  {0xffff, UUID_INIT(0xA19D880F, 0x05FC, 0x4D3B, 0xA0,0x06,0x74,0x3F,0x0F,0x84,0x91,0x1E), "Unused"}
