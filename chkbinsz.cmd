...
rem c:\windows\system32\forfiles.exe /p arch /s /m IPL0*.bin /c "cmd /c if @fsize neq 440 echo **** @file @fsize SIZE MUST BE 440 ****"
c:\windows\system32\forfiles.exe /p arch /s /m IPL0*.bin /c "cmd /c if @fsize neq 436 echo **** @file @fsize SIZE MUST BE 436 ****"
